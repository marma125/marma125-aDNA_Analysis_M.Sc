...
# 
# Initial Script to do descriptive data analysis for the Master Thesis with the working title: 
# Prokaryotic community patterns in the Atlantic during the LGM - Holocene transition 
# and their implications for the marine carbon pump; insights from aDNA!
# This script performs hierarchical clustering, NMDS, CCA, sPLS and WGCNA analysis
# on the genus level including all TSS scaled, damaged and mapped reads from all samples.
# Requires: libraries
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
